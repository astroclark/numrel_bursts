...
"""
nrburst_extract_modedata.py

Extract mode data from hdf5 file so we can resort to the old-school NR frames
...
def get_data_from_h5_file(filepointer, key_name):
    """ 
...
mode_data = get_data_from_h5_file(file
